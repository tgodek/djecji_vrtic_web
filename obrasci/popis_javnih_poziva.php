...
<head>
    <title>Popis javnih poziva</title>
    <meta charset="UTF-8">
    ...
    <script type="text/javascript" src="../javascript/popis_javnih_poziva.js"></script>
</head>
        ...
        <div class="vrtic-content"> 
            ...
            <table name="popis_javnih_poziva_tablica" id="popis_javnih_poziva_tablica" class="prijava_djeteta_table">
                <thead>
                    <tr>
                        <th>Broj mjesta</th>
                        <th>Datum otvaranja javnog poziva</th>
                        <th>Datum zatvaranja javnog poziva</th>
                    </tr>
                </thead>
